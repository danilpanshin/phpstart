    	...
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        	<tr>
                ...
                <td class="right-collum-index">
					...
					<div style="clear: both;"></div>
 					...
 					<?php if (isset($_GET["login"]) && $_GET["login"] == "yes"): ?>
						<form action="index.php" method="POST">
							<p>Ваш e-mail: <input id="login_id" size="30" name="login" /></p>
								
							<p>Ваш пароль: <input id="login_id" size="30" name="password" /></p>
				    ...
				    <?php endif; ?>
				    <?php if (!empty($_POST) && in_array($_POST["login"], $logins)): ?>
				        <p> Uspeshno!</p>
				    <?php else: ?>
				      <p> ne sovpadaet!</p>    
				    <?php endif; ?>     
